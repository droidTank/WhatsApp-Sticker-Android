...
public class StickerPackDetailsActivity extends AddStickerPackActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_info && stickerPack != null) {
            final String publisherWebsite = stickerPack.getPublisherWebsite();
            final String publisherEmail = stickerPack.getPublisherEmail();
            final String privacyPolicyWebsite = stickerPack.getPrivacyPolicyWebsite();
            Uri trayIconUri = Uri.parse(stickerPack.getTrayImageUrl());
